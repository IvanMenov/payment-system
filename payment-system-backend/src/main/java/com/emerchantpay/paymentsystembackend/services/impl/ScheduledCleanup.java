...
import com.emerchantpay.paymentsystembackend.services.IScheduledTask;
...
public class ScheduledCleanup implements IScheduledTask {
    ...
    @Value("${scheduled.cleanup.disabled}")
    private boolean scheduledCleanupDisabled;
                        ...
                        transactionList.forEach(
                                transaction -> {
                                    ...
                                    if (transaction.getTransactionType() == TransactionType.CHARGE
                                            && transaction.getTransactionStatus() == Transaction.Status.APPROVED) {
